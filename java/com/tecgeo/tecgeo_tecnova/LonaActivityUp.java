...
public class LonaActivityUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lona_up);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(LonaActivityUp.this, LonaActivity.class);
    ...
    public void buttonAtualizarLona(View view) {
        ...
        if (Slocal.isEmpty() || SETdescricao.isEmpty() ) {
            ...
            String url = "http://192.168.25.218:3000/lona/atualizar/" + id_solicitacao_lona;
    ...
    public void buttonDeletaLona(View view) {
        ...
        builder.setPositiveButton("Confirmar", (dialog, which) -> {
            ...
            String url = "http://192.168.25.218:3000/lona/deletar/" + id_solicitacao_lona;
    ...
    public void buttonVizualizarLona(View view) {
        if (pontoLonaX != null && pontoLonaY != null) {
                if (point != null) {
                    Intent intent = new Intent(LonaActivityUp.this, MapDinamicActivity.class);
                    intent.putExtra("pontoXClicadoUP", point.getX());
                    intent.putExtra("pontoYClicadoUP", point.getY());
                    intent.putExtra("LonaActivityUp", "true");
                    startActivity(intent);
                    finish();
                }
        }
