...
public class VistoriaActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        Intent intent = new Intent(VistoriaActivity.this, MainActivity.class);
        startActivity(intent);
        finish();
    }

    private void inicializaComponentes() {
        listview = findViewById(R.id.listViewVistoria);
        Toast.makeText(
                VistoriaActivity.this,
                "Carregando dados...",
                Toast.LENGTH_SHORT
        ).show();
    }
    ...
    private void obterDados() {
        ...
        String url = "http://192.168.25.218:3000/vistoria/listar";
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null,
                response -> {

                    try {
                        jsonArray = response.getJSONArray("vistoria");
                            ...
                            listview.setOnItemClickListener((parent, view, position, id) -> {
                                ...
                                try {
                                    ...
                                    if (SHAPE.equals("null")) {
                                        ...
                                        id_vistoria = jsonArray.getJSONObject(position).getInt("id_vistoria");
                                        ...
                                        Intent intent = new Intent(VistoriaActivity.this, VistoriaActivityUp.class);
                                        intent.putExtra("pontoXClicadoUP", String.valueOf(x));
                                        intent.putExtra("pontoYClicadoUP", String.valueOf(y));
                                        intent.putExtra("id_solicitacao_lona", id_vistoria);
    ...
    public void buttonAddVistoria(View view) {
        Intent intent = new Intent(VistoriaActivity.this, MapDinamicEditAcitivity.class);
        intent.putExtra("VistoriaActivity", "true");
        startActivity(intent);
        finish();
    }
