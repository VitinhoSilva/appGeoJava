...
public class LonaActivityNew extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lona_new);
    ...
    public void onBackPressed() {
        ...
        builder.setPositiveButton("Confirmar", (dialog, which) -> {
            ...
            String url = "http://192.168.25.218:3000/lona/deletarObjId/" + OBJECTID;
            StringRequest dr = new StringRequest(Request.Method.DELETE, url,
                    response -> {
                        Intent intent = new Intent(LonaActivityNew.this, LonaActivity.class);
    ...
    public void buttonSalvarLona(View view) {
        ...
        if (endereco.isEmpty() || descricao.isEmpty()) {
            ...
            String url = "http://192.168.25.218:3000/lona/atualizarObjId/" + OBJECTID;
        ...
        StringRequest dr = new StringRequest(Request.Method.DELETE, url,
                response -> {
                    if (response.equals("Deletado com sucesso!")){
                        ...
                        Intent intent = new Intent(LonaActivityNew.this, MainActivity.class);
                        startActivity(intent);
                        finish();
                    }
                },
